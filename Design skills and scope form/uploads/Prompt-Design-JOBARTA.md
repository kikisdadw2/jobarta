...
WARNA (pakai token, jangan hex mentah di komponen)
--color-primary      #0369A1   biru profesional (aksi utama, header)
--color-on-primary   #FFFFFF
--color-secondary    #0EA5E9   biru terang (aksen, link)
--color-accent       #16A34A   hijau (sukses, badge TERVERIFIKASI, CTA lamar)
--color-background   #F0F9FF
--color-foreground   #0C4A6E
--color-muted        #E7EFF5
--color-border       #BAE6FD
--color-destructive  #DC2626   (error, tombol lapor)
--color-ring         #0369A1   (focus ring)
Catatan: hijau aksen sengaja #16A34A (bukan #22C55E) supaya lolos kontras 3:1.
...
warna sebagai satu-satunya penanda makna.
...
1. Navbar — logo JOBARTA, "Cari Lowongan", "Untuk Perusahaan", tombol "Masuk dengan Google".
...
Desain alur onboarding setelah user login Google pertama kali.
Karena auth-nya OAuth Google, TIDAK ADA halaman daftar berisi form email/password.
